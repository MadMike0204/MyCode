...
def create_graph():
    ...
    edges=[(0,1),(0,3),(0,6),
       ...
       (11,10), (11,12), (11,20), (11,41),(11,19),
       (12,7), (12,11), (12,35),
       (13,14), (13,15), (13,38), (13,39),
       (14,13),(14,17),(14,21),
       (15,2),(15,13),(15,42),
       (16,5),(16,10),(16,18),(16,36),
       (17,14),(17,21),(17,39),(17,7),
       (18,2),(18,16),(18,19),(18,23),
       (19,10),(19,18),(19,20),(19,23),(19,37),
       (20,11),(20,19),
       (21,14),(21,17),
       (22,5),(22,34),(22,40),
       (23,18),(23,19),
       (24,7),(24,32),
       (25,30),(25,33),
       (26,31),(26,32),(26,33),(26,28),
       (27,30),(27,33),(27,35),(27,25),
       (28,8),(28,35),(28,37),(28,26),
       (29,31),(29,32),
       (30,25),(30,27),
       (31,26),(31,29),
       (32,24),(32,26),(32,29),
        ...
        for path_index, path in enumerate(paths):
            ...
            for i in range(len(path) - 1):
                ...
                while segment_loads[segment] > capacities[segment]:
                    adjusted = True
                    excess = segment_loads[segment] - capacities[segment]
                    reduce_amount = excess / demands[(source, target)] if demands[(source, target)] > 0 else 0
                    individual[path_index] -= reduce_amount
                    segment_loads[segment] -= excess
            if adjusted:
                # Recalculate the path demand after adjustment
                individual[path_index] = max(individual[path_index], 0)  # Ensure no negative weights
                path_demand = individual[path_index] * demands[(source, target)]
                for i in range(len(path) - 1):
                    segment = (path[i], path[i+1])
                    segment_loads[segment] = max(segment_loads[segment] - path_demand, 0)  # Recalculate load
...
def main():
    ...
    filepathC = r'F:\------------------OWN\VSCode\Python\Math\MathClub\51club\B\data\4-LCNetwork3.xlsx'
    ...
    with pd.ExcelWriter('GP-Problem4-data'+datetime.now().strftime("%Y%m%d%H%M")+'.xlsx') as writer:
